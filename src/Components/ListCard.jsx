...
//           <img className="h-full w-fit flex justify-center items-center
//           " src={image} alt="" />
//         </div>
...
//             <div className="divider"></div>
//             <div>
//               <span className="font-bold">Review:</span> <span>{review}</span>
//             </div>
...
//       </div>
//             <div className="flex ">
//               <span>Number of Pages: <span className="font-bold"> {totalPages}</span></span>
//             </div>
//             <div className="flex ">
