  ...
  return (
    ...
    >
      ...
      <div className="flex gap-2 my-5">
        <p className="px-2 py-1 text-xs rounded-full font-bold text-[#23BE0A] bg-[#23BE0A0D]">{tags[0]}</p>
        <p className="px-2 py-1 text-xs rounded-full font-bold text-[#23BE0A] bg-[#23BE0A0D]">{tags[1]}</p>
      </div>
      <div className=" space-y-2">
        ...
        <div className="flex justify-between">
          <p>{category}</p>
          <p className="flex justify-center items-center">{rating} <FaStar size={20} className="text-yellow-300 ml-1"/></p>
        </div>
      </div>
    </Link>
  );
